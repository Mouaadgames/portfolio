    ...
    <div ref={ref} className="hero min-h-screen bg-base-200">
      <div className="hero-content flex-col-reverse lg:flex-row-reverse">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-control">
                <div className='flex flex-col sm:flex-row gap-2'>
                  <input required name='name' id='name' type="text" placeholder="name" className="input flex-1 w-full p-4 sm:w-6  input-bordered rounded-none" />
                  <ValidationError
                    prefix="Name"
                    field="name"
                    errors={state.errors}
                  />
                  <input required name='email' id='email' type="email" placeholder="email" className="input w-full p-4 sm:w-6  flex-1 input-bordered rounded-none" />
                  <ValidationError
                    prefix="Email"
                    field="email"
                    errors={state.errors}
                ...
                <textarea required name='message' id='message' type="text" placeholder="message" className="mt-2 h-28 input input-bordered rounded-none" />
                <ValidationError
                  prefix="Message"
                  field="message"
                  errors={state.errors}
        ...
        <div className="text-center lg:text-left mx-4">
          ...
          <p><span>Phone :</span> <span>+212 65570-5822</span></p>
        </div>
      </div>
    </div>)
}
